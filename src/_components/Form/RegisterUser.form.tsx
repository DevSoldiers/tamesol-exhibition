...
const RegisterUserForm = ({ isModal }: { isModal: boolean }) => {
  ...
  return (
    <div className="flip-card w-full flex items-center justify-center min-h-screen -mt-24">
      <div className="relative perspective w-full">
        ...
        >
          {/* Front Side */}
          <div
            className="absolute w-full h-full border border-gray-200 rounded-lg shadow-lg flex items-center justify-center"
          ...
          {/* Back Side */}
          <div
            className="absolute w-full h-full bg-yellow-200 border border-gray-200 rounded-lg shadow-lg flex items-center justify-center"
