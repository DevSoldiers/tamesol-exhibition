...
export default function HowToParticipate() {
    ...
    return (
        <>
            <article className="flex items-center justify-center py-10 bg-gradient-to-r from-purple-50 to-indigo-50 px-4 md:px-0">
            ...
            {isModalOpen && (
                ...
                >
                    <div
                        className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full mx-4 relative"
                    ...
                    >
                        ...
                        {/* Modal Content */}
                        <h2 className="text-BroadcastChannel text-2xl font-bold mb-4">
                            {t('more_info')}
                        </h2>
