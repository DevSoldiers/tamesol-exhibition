        ...
        <article className="card_wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {
            Array(3).fill(0).map((_, key) => (
              <article className="max-w-sm rounded overflow-hidden shadow-lg" key={key}>
                <Image width={200} height={200} className="w-full" src="/hero_exhibition_placeholder.jpeg" alt="Sunset in the mountains" />
                <div className="px-6 py-4">
                  ...
                  <p className="text-gray-700 text-base">
                    የአዲስ ነገር ኤክስፖን የመግቢያ ትኬት ቀድመዉ 100 ብር ብቻ ! በመግዛት የልዩ ቅናሽ ተጠቃሚ ይሁኑ፡፡ አዲስ ነገር ኤክስፖ በዉስጡ የተለያዩ የሽመታ፣ የመዝናኛ፣ የምግብ እና መጠጥ፣ የጤና እና ዉበት፣ የቢዝነስ እና ሪልእስቴት መንደሮችን የያዘ ሲሆን የአዲስ መኪና ሽልማት እንዲሁም በየቀኑ አዳዲስ ልዩ ሽልማቶች አሉት ፡፡ እርስዎ እድለኛ ቢሆኑስ ?                  </p>
                </div>
                <div className="px-6 pt-4 pb-2">
                  <Button className="text-white px-4 py-5 bg-[#f59c38]">
                    ትኬትዎን ይቁረጡ
                  </Button>
                </div>
              </article>
